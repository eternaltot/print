            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <a href="{{ url('/admin/frames/create') }}" class="btn btn-success btn-sm" title="Add New Frame">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                        </a>

                        {!! Form::open(['method' => 'GET', 'url' => '/admin/frames', 'class' => 'navbar-form navbar-right', 'role' => 'search'])  !!}
                        ...
                        <div class="table-responsive">
                            ...
                            <div class="pagination"> {!! $frames->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
